...
describe("Totalizador", () => {
  ...
  it("deberia mostrar el costo de envio de $3.5 para peso volumétrico entre 11 y 20", () => {
    expect(totalizador.obtenerCostoEnvioPorUnidad(15)).toEqual(3.5);
  });
  ...
  it ("deberia mostrar el costo de envio de $6.5 para peso volumétrico entre 81 y 100", () => {
    expect(totalizador.obtenerCostoEnvioPorUnidad(90)).toEqual(6.5);
  });

  it ("deberia mostrar el costo de envio de $8 para peso volumétrico entre 101 y 200", () => {
    expect(totalizador.obtenerCostoEnvioPorUnidad(150)).toEqual(8);
  });
  ...
  it("cliente recurrente deberia tener descuento de envio 0.5%", () => {
    expect(totalizador.obtenerDescuentoEnvioCliente("recurrente")).toEqual(0.5);
  });

  it("cliente antiguo recurrente deberia tener descuento de envio 1%", () => {
    expect(totalizador.obtenerDescuentoEnvioCliente("antiguo recurrente")).toEqual(1);
  });
